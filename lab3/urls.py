...
urlpatterns = [
   ...
   path(r'actions/post/images/<int:pk>/', views.postImageToAction, name='actions_post_image'), # +
   ...
   path(r'applications/actions/<int:pk>/', views.get_detail_applications_list_actions, name='applications_detail'),
   path(r'applications/put/<int:pk>/', views.put_detail_applications, name='applications_put'),  # +
   path(r'applications/delete/<int:pk>/', views.delete_detail_from_application, name='applications_delete'),
   path(r'application/delete/<int:pk>/', views.delete_application, name='applications_delete'),
   path(r'applications/put/moderator/', views.put_detail_applications_moderator, name='applications_put_moderator'), # +
   path(r'applications/put/user/', views.put_detail_applications_user, name='applications_put_user'), # +

   path(r'actions/applications/delete/<int:pk>/', views.DeleteApplicationAction, name = 'application_action_delete'), # +
   path(r'actions/applications/put/', views.PutApplicationActions, name = 'application_action_put'), # +

   path(r'actions/play/<int:pk>/', views.PlayActions, name="play_actions"),
   path(r'actions/process/response', views.ProcessAnswer, name="process_answer"),
